...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DOMPositionUtils = __webpack_require__(7);
	...
	var ReduxInfiniteScroll = function (_React$Component) {
	  ...
	  _createClass(ReduxInfiniteScroll, [{
	    ...
	    value: function _findElement() {
	      ...
	      if (this.props.elementIsScrollable) return _reactDom2.default.findDOMNode(this);
	      return window;
	    }
	  }, {
	    ...
	    value: function scrollListener() {
	      ...
	      var scrollableEl = this.props.elementIsScrollable || this.props.scrollableElement;
	      var bottomPosition = scrollableEl ? this._elScrollListener() : this._windowScrollListener();
	...
	ReduxInfiniteScroll.propTypes = {
	  ...
	  scrollableElement: _propTypes2.default.any,
